...
class ConvNet(nn.Module):
	def __init__(self, input_dim, output_dim, dropout=0.0, device='cuda'):
		...
		self.fc2 = nn.Linear(100, output_dim, bias=False)
		
	def forward(self, x, lengths): # NOTE: lengths variable is there in purpose even if it is not used
